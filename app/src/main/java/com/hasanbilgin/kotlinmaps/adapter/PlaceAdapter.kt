package com.hasanbilgin.kotlinmaps.adapter

import android.content.Intent
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.hasanbilgin.kotlinmaps.databinding.RecyclerRowBinding
import com.hasanbilgin.kotlinmaps.model.Place
import com.hasanbilgin.kotlinmaps.view.MapsActivity
...
class PlaceAdapter(val placeList: List<Place>) : RecyclerView.Adapter<PlaceAdapter.PlaceHolder>() {
    ...
    override fun onBindViewHolder(holder: PlaceHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            //model Placeye Serializable eklendi
